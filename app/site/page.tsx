...
export default function Home() {
    return (
        <main className="">
            <section
                className={
                    'w-full h-full pt-36 relative flex items-center justify-center flex-col'
                }>
                <div
                ...
                <div
                    className={
                        'flex justify-center items-center relative md:mt-[-70px]'
                    }>
                    <Image
                        ...
                        width={1200}
                        className={
                            'rounded-tl-2xl rounded-tr-2xl border-2 border-muted'
                        }
                    />
                    <div
                        className={
