...
const InfoBar = ({ notifications, role, className, subAccountId }: Props) => {
    ...
    return (
        <>
            <div
                className={twMerge(
                    'fixed z-[20] md:left-[300px] left-0 right-0 top-0 p-4 bg-background/80 backdrop-blur-md flex gap-4 items-center border-b-[1px] dark:border-gray-800',
                    className,
                )}>
                <div className={'flex items-center gap-2 ml-auto'}>
                    ...
                    <Sheet>
                        ...
                        <SheetContent
                            className={
                                'mt-4 mr-4 pr-4 flex flex-col !dark:border-gray-800'
                            }>
